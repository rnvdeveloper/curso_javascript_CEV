...
function media() {
    ...
    let bloco = `<p>Veja abaixo o cálculo da média de ${nome}:</p>
                <p>As notas inseridas para ${nome} foram: ${n1}, ${n2}, ${n3} e ${n4}.</p>
                <p>De acordo com as notas inseridas a média final é igual a ${media.toLocaleString("pt-BR")}</p>`

    if (n1 > 10 || n2 > 10 || n3 > 10 || n4 > 10) {
        alert("Uma das notas foi inserida incorretamente, por favor, revisar os dados.")
    } else if (media >= 7) {
        interacao.innerHTML = bloco
